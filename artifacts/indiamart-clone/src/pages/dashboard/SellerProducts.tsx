...
import { Plus, Package, Pencil, Trash2, Eye, IndianRupee } from 'lucide-react';
  ...
  const handleDelete = () => {
    ...
    deleteProduct.mutate(
      { id: deletingId },
      {
        ...
        onError: (err: any) => {
          toast({ title: 'Failed to delete product', description: err?.error ?? 'Unknown error', variant: 'destructive' });
          setDeletingId(null);
        },
      }
    );
      ...
      <div className="space-y-6">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-20 bg-muted/30 rounded-xl border border-dashed border-border">
            ...
            <p className="text-muted-foreground mb-6">Start adding products so buyers can find your listings.</p>
            <Button asChild>
              <Link href="/dashboard/seller/products/new">
          ...
          <div className="space-y-4">
            {products.map((product) => (
              <Card key={product.id} className="border-border/50 hover:border-primary/30 transition-colors">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap items-center gap-4 text-sm">
                        <span className="flex items-center gap-1 font-semibold text-foreground">
                          ...
                          <span className="text-muted-foreground font-normal ml-0.5">/ {product.unit}</span>
                        </span>
      ...
      <AlertDialog open={deletingId !== null} onOpenChange={(open) => !open && setDeletingId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently remove the product listing. Existing inquiries linked to it will remain but the listing won't be accessible.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
